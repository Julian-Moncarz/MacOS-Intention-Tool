...
def main():
    ...
    # Load the CSV file (adapted for current repo structure)
    ...
    # Clean the Intent column (adapting to current column names)
    ...
    print(f"✓ Saved full data to: data/embeddings_data.json and data/embeddings_data.pkl")
    print(f"✓ Saved summary to: data/embeddings_summary.csv")
    print("="*50)
